...
Original file is located at
    https://colab.research.google.com/drive/1K2jakvBL-FcSjzOCKLQi7Jsl2g5V6y4N

https://phamdinhkhanh.github.io/2020/05/28/TransformerThemDauTV.html

https://forum.machinelearningcoban.com/t/aivivn-3-vietnamese-tone-prediction-2nd-place-solution/5759
"""

# Commented out IPython magic to ensure Python compatibility.
# from google.colab import drive
# drive.mount('/content/drive')
# %cd /content/drive/MyDrive/Machine Learning/NLP/Transformer/Demo
...
from tqdm import tqdm # tạo thanh hiển thị tiến trình

# train_idx_500k = [] # lưu chỉ số
# train_opt_500k = [] # lưu câu có dấu
# train_ipt_500k = [] # lưu câu bỏ dấu
#
# val_idx_50k = []
# val_opt_50k = []
# val_ipt_50k = []
...
# test_opt_50k = []
# test_ipt_50k = []
# tokenizer_ipt = _load_pickle('./tokenizer_ipt.pkl')
# tokenizer_opt = _load_pickle('./tokenizer_opt.pkl')
# for i in tqdm(range(600000)):
#   [idx, origin_seq] = doc[i].split('\t')
#   try:
#     non_acc = remove_tone_line(origin_seq)
#   except:
#     print('error remove tone line at sequence {}'.format(str(i)))
#     continue
#   if i<500000:
#     train_idx_500k.append(idx)
#     train_opt_500k.append(origin_seq)
#     train_ipt_500k.append(non_acc)
#   elif i<550000:
#     val_idx_50k.append(idx)
#     val_opt_50k.append(origin_seq)
#     val_ipt_50k.append(non_acc)
#   else:
#     test_idx_50k.append(idx)
#     test_opt_50k.append(origin_seq)
#     test_ipt_50k.append(non_acc)

# _save_pickle('./train_idx_500k.pkl', train_idx_500k)
# _save_pickle('./train_opt_500k.pkl', train_opt_500k)
# _save_pickle('./train_ipt_500k.pkl', train_ipt_500k)
# _save_pickle('./val_idx_50k.pkl', val_idx_50k)
# _save_pickle('./val_opt_50k.pkl', val_opt_50k)
# _save_pickle('./val_ipt_50k.pkl', val_ipt_50k)
...
train_idx_500k = _load_pickle('tokenizer./train_idx_500k.pkl')
train_opt_500k = _load_pickle('tokenizer./train_opt_500k.pkl')
train_ipt_500k = _load_pickle('tokenizer./train_ipt_500k.pkl')
val_idx_50k = _load_pickle('tokenizer./val_idx_50k.pkl')
val_opt_50k = _load_pickle('tokenizer./val_opt_50k.pkl')
val_ipt_50k = _load_pickle('tokenizer./val_ipt_50k.pkl')
...
# Tạo Dataset để dễ kiểm soát batch, shuffle, ...
# https://viblo.asia/p/chuan-bi-du-lieu-voi-tensorflow-dataset-oOVlYzAV58W
...
train_dataset = train_dataset.shuffle(BUFFER_SIZE).padded_batch(BATCH_SIZE) # tạo batch_size và pad 0 vào cuối để mỗi hàng dl có chiều dài như nhau
...
# Learning rate và phương pháp tối ưu
...
checkpoint_path = "./checkpoints/pretrained/train_500k"
...
Chạy cell đầu tiên, mount vào drive chứa dữ liệu.

Đứng tại ô này, chọn:

**Thời gian chạy --> Thực thi các ô trước**

Sau đó chạy các ô bên dưới để test kết quả

Cell 34 chạy có thể lâu, từ các lần chạy test sau sẽ nhanh hơn
"""

if __name__ == '__main__':

  result = add_diacritic("thoi tiet hom nay thich hop de di choi da ngoai")
  print(result)
